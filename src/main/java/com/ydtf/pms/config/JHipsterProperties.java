...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pms@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pms API";

        private String description = "pms API documentation";
